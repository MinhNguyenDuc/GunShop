                        ...
                        <div class="portlet-body flip-scroll">
                            <table class="table table-bordered table-striped table-condensed flip-content">
                                ...
                                <tr>
                                    ...
                                    <th class="numeric"> Video Id </th>
                                    <th class="numeric"> Category Id </th>
                                    <th class="numeric"> Ammo </th>
                                    <th class="numeric"> Magazine Capability </th>
                                    <th class="numeric"> Range </th>
                                    <th class="numeric"> Bullet Speed </th>
                                    <th class="numeric"> Fire Rate </th>
                                ...
                                <tr>
                                    <td>{{$item->id}}</td>
                                    <td> {{$item->name}} </td>
                                    <td class="numeric" width="10%"><img src="{{$item->image}}" width="100%" alt=""></td>
                                    <td class="numeric"> {{$item->videoId}}</td>
                                    <td class="numeric"> {{$item->categoryId}}</td>
                                    <td class="numeric"> {{$item->ammo}}</td>
                                    <td class="numeric"> {{$item->magazine_capability}} </td>
                                    <td class="numeric"> {{$item->range}} </td>
                                    <td class="numeric"> {{$item->bullet_speed}}</td>
                                    <td class="numeric"> {{$item->fire_rate}}</td>
                                    <td class="numeric"> {{$item->description}}</td>
                                    <td class="numeric"> {{$item->detail}}</td>
                                    <td class="numeric"> {{$item->price}}</td>
                                    <td class="numeric"> {{$item->status}}</td>
                                    <td class="numeric"> {{$item->created_at}}</td>
                                    <td class="numeric"> {{$item->updated_at}}</td>
                                    <td class="numeric"><button class="btn btn-success" onclick="location.href = '/admin/gunshop/{{$item->id}}/edit'">Edit</button></td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($list_category as $item)
                                        <tr>
                                            <td> {{$item->id}} </td>
                                            <td> {{$item->name}} </td>
                                            <td width="10%"><img src="{{$item->image}}" width="100%"  alt=""></td>
                                            <td> {{$item->description}} </td>
                                            <td class="numeric"><button class="btn btn-success" onclick="location.href = '/admin/gunshop/category/{{$item->id}}/edit'">Edit</button></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
