...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal form-row-seperated" action="/admin/gunshop" method="post">
                        {{csrf_field()}}
                        <div class="portlet">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-shopping-cart"></i>Add new Guns</div>
                                        ...
                                        <div class="tab-pane active" id="tab_general">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" name="videoId" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="table-group-action-input form-control input-medium" name="categoryId" id="">
                                                            ...
                                                            <option value="2">Shotguns</option>
                                                            <option value="3">SMGs</option>
                                                            <option value="4">ARs</option>
                                                            <option value="5">Snipper Rifle</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" name="ammo" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" name="magazine_capability" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" name="range" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" name="bullet_speed" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" name="fire_rate" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
